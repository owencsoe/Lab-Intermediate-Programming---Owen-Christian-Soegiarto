...
# Form Input
tk.Label(root, text="Nama", bg="red", fg="white").grid(row=0, column=0, padx=10, pady=5, sticky="w")
tk.Label(root, text="Alamat", bg="orange", fg="white").grid(row=1, column=0, padx=10, pady=5, sticky="w")
tk.Label(root, text="No Telp", bg="green", fg="white").grid(row=2, column=0, padx=10, pady=5, sticky="w")
tk.Label(root, text="Email", bg="blue", fg="white").grid(row=3, column=0, padx=10, pady=5, sticky="w")
...
# Buttons
tk.Button(root, text="Add", command=on_add, bg="grey", fg="white").grid(row=4, column=0, padx=10, pady=5)
tk.Button(root, text="Update", command=on_update, bg="grey", fg="white").grid(row=4, column=1, padx=10, pady=5)
tk.Button(root, text="Delete", command=on_delete, bg="grey", fg="white").grid(row=4, column=2, padx=10, pady=5)
